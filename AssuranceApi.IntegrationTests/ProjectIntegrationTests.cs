...
public class ProjectIntegrationTests : IClassFixture<TestApplicationFactory>
{
    ...
    public async Task GetProjectById_ReturnsNotFound_WhenProjectDoesNotExist()
    {
        ...
        var response = await client.GetAsync($"/projects/{nonExistentId}");
    ...
    public async Task GetProjectById_ReturnsProject_WhenProjectExists()
    {
        ...
        await authenticatedClient.PostAsJsonAsync("/projects", project);

        // Act - Use public client to test read access
        var response = await publicClient.GetAsync($"/projects/{projectId}");
    ...
    public async Task GetProjects_ReturnsProjects_WhenProjectsExist()
    {
        ...
        // Act - Use public client to test read access
        var response = await publicClient.GetAsync("/projects");
    ...
    public async Task GetProjectsWithTagFilter_ReturnsFilteredResults()
    {
        ...
        // Create the projects
        await authenticatedClient.PostAsJsonAsync("/projects", project1);
        await authenticatedClient.PostAsJsonAsync("/projects", project2);

        // Act - Filter by API tag
        var response = await publicClient.GetAsync("/projects?tag=api");
    ...
    public async Task UpdateProject_ReturnsOk_WhenValidUpdateProvided()
    {
        ...
        // Create the project first
        await client.PostAsJsonAsync("/projects", originalProject);
        ...
        // Act
        var response = await client.PutAsJsonAsync($"/projects/{projectId}", updatedProject);
    ...
    public async Task UpdateProject_RequiresAuthentication()
    {
        ...
        // Act
        var response = await client.PutAsJsonAsync($"/projects/{projectId}", project);
    ...
    public async Task GetProjectHistory_ReturnsOk_WhenProjectExists()
    {
        ...
        var response = await publicClient.GetAsync($"/projects/{projectId}/history");
    ...
    public async Task GetTagsSummary_ReturnsOk()
    {
        ...
        var response = await publicClient.GetAsync("/projects/tags/summary");
