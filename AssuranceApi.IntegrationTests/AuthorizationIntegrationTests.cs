...
public class AuthorizationIntegrationTests : IClassFixture<TestApplicationFactory>
{
    ...
    [Theory]
    [InlineData("/api/v1.0/professions")] // GET endpoints should be public
    [InlineData("/api/v1.0/serviceStandards")]
    [InlineData("/api/v1.0/projects")]
    [InlineData("/health")]
    ...
    [Theory]
    [InlineData("POST", "/api/v1.0/professions")] // Protected admin endpoints
    [InlineData("DELETE", "/api/v1.0/professions/test-id")]
    [InlineData("POST", "/api/v1.0/professions/deleteAll")]
    [InlineData("POST", "/api/v1.0/serviceStandards/seed")]
    [InlineData("DELETE", "/api/v1.0/serviceStandards/test-id")]
    [InlineData("POST", "/api/v1.0/projects")]
