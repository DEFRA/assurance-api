...
namespace AssuranceApi.Tests.Utils.Mongo
{
    public class MongoServiceTests
    {
        ...
        public MongoServiceTests()
        {
            ...
            _collectionMock
                .DidNotReceive()
                .Indexes.CreateMany(Arg.Any<IEnumerable<CreateIndexModel<TestModel>>>());
        }
        ...
        public void EnsureIndexes_CreatesIndexes_WhenIndexesAreDefined()
        {
            ...
            {
                new CreateIndexModel<TestModel>(
                    Builders<TestModel>.IndexKeys.Ascending(x => x.Name)
                ),
            };
        ...
        {
            protected List<CreateIndexModel<TestModel>> _indexes =
                new List<CreateIndexModel<TestModel>>();
